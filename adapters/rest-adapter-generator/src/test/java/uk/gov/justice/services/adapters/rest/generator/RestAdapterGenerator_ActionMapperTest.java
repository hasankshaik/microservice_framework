...
public class RestAdapterGenerator_ActionMapperTest extends BaseRestAdapterGeneratorTest {
    ...
    public void shouldReturnActionNameForPOSTResource() throws Exception {
        ...
        Object action = actionMethod.invoke(mapperObject, "postVndCtxCommandSomemediatype1JsonCase", "POST",
                headersWith("Content-Type", "application/vnd.ctx.command.somemediatype1+json"));
        assertThat(action, is("contextB.someAction"));

        action = actionMethod.invoke(mapperObject, "postVndCtxCommandSomemediatype2JsonCase", "POST",
    ...
    @Test
    public void shouldReturnActionNameForPOSTResource_SameActionMappedToTwoMediaTypes() throws Exception {
        generator.run(
                restRamlWithDefaults()
                        .with(resource("/case")
                                .with(httpAction(POST)
    ...
    public void shouldReturnActionNameForPOSTAndGETResource() throws Exception {
        ...
        Object action = actionMethod.invoke(mapperObject, "postVndSomemediatype1JsonCase", "POST",
